...
from processing.deprecated_types.BuilderProcessorInterface import \
    BuilderProcessorInterface
from processing.deprecated_types.IndicatorJSONType import IndicatorJSONType
