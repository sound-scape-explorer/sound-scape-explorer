...
function archive_sse_cpu_docker_windows(){
  ...
  zip sse-cpu-docker-windows.zip ./* -x "*.gitignore"
...
function archive_sse_cuda_docker_windows(){
  ...
  zip sse-cuda-docker-windows.zip ./* -x "*.gitignore"
...
function archive_sse_next_docker_windows(){
  ...
  zip sse-next-docker-windows.zip ./* -x "*.gitignore"
...
function archive_sse_web_docker_linux(){
  ...
  zip sse-web-docker-linux.zip ./* -x "*.gitignore"
...
function archive_sse_web_docker_windows(){
  ...
  zip sse-web-docker-windows.zip ./* -x "*.gitignore"
